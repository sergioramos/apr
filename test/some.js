...
test('fail [] some', schedule(async (t) => {
...
test('fail @@Iterator some', schedule(async (t) => {
...
test('fail [] someSeries', schedule(async (t) => {
...
test('fail @@Iterator someSeries', schedule(async (t) => {
