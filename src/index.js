module.exports = {
  ...
  detect: require('./find'),
  detectSeries: require('./find').series,
  detectLimit: require('./find').limit,
  detectOf: require('./find'),
  detectOfSeries: require('./find').series,
  detectOfLimit: require('./find').limit,
  ...
  timesLimit: require('./times').limit,
